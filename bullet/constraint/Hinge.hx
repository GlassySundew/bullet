...
class Hinge extends Constraint {
	...
	var hg : Bullet.HingeConstraint;

	public function new( body : Body, pivot : Point, axis : Point, body2 : Body, pivot2 : Point, axis2 : Point, ?world : World ) {
		var pv : Bullet.Vector3 = pivot == null ? Body.zero : pivot;
		var pv2 : Bullet.Vector3 = pivot2 == null ? Body.zero : pivot2;
		var ax : Bullet.Vector3 = axis;
		var ax2 : Bullet.Vector3 = axis2;
		@:privateAccess hg = new Bullet.HingeConstraint(body.inst, cast body2.inst, cast pv, cast pv2, ax, ax2);
